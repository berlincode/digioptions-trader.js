...
//  };
  ...
  self.inCancelDistanceOnScroll = function() {
  ...
  self.overlayClicked = (function() {
    if (this.props.open) {
      this.props.onSetOpen(false);
    }
  }).bind(self);

  self.saveSidebarWidth = (function() {
  ...
  self.saveSidebarRef = (function(node) {
    this.sidebar = node;
  }).bind(self);

  // calculate the sidebarWidth based on current touch info
  self.touchSidebarWidth = function() {
  ...
  self.render = function() {
    var sidebarStyle = Object.assign({},
    ...
    var overlayStyle = Object.assign({},
    ...
    var rootProps = {
      ...
      style: Object.assign({}, defaultStyles.root, this.props.styles.root),
      role: "navigation",
    ...
    if (useTouch) {
      if (this.props.open) {
        ...
        var dragHandleStyle = Object.assign({},
  ...
  Sidebar.prototype = Object.create(React.PureComponent.prototype);
