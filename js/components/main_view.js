...
(function (root, factory) {
  ...
  function MarketViewHeadWrapped() {
    ...
    self.render = function(){
      return (
        React.createElement('li', {role: 'presentation', className: self.props.selected? 'active': ''},
  ...
  function NetworkTab() {
    ...
    self.render = function(){
      return (
        React.createElement('li', {className: self.props.selected? 'active': ''},
          React.createElement('a', {href: '#', onClick: self.clickNetwork},
            self.props.network
          )
        )
      );
        ...
        sidebarContent = (
          React.createElement(React.Fragment, null,
            ...
            React.createElement('div', null,
              React.createElement('dl', {className: 'dl-horizontal'},
                React.createElement('dt', {style: {textAlign: 'left'}}, 'uptime:'),
                React.createElement('dd', null, intervalString(this.props.uptime)),
