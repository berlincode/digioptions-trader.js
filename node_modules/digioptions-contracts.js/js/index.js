...
(function (root, factory) {
  ...
  function contractInfoToContractDescription(web3, contractAddr, contractInfo){
    ...
    var digiOptionsMarketsAddr = contractInfo[3].toHexString(); // TODO real 0x0Eb7e02ED6C8a55f72551E8677eE3bbB25263016 with addess with exact 20bytes (maybe with leading zeroes)
    ...
    var payoutPerNanoOptionExp = web3Utils.toBN(contractInfo[7]);
    var existingMarkets = web3Utils.toBN(contractInfo[8]);

    /*
    console.log('contractType', contractType);
    console.log('blockNumberCreated', blockNumberCreated);
    console.log('timestampMarketsCreated', timestampMarketsCreated);
    console.log('versionMarketLister', versionMarketLister);
    console.log('versionMarkets', versionMarkets);
    console.log('offer_max_blocks_into_future', offer_max_blocks_into_future);
    console.log('digiOptionsMarketsAddr', digiOptionsMarketsAddr);
    */
    var contractMarkets = new web3.eth.Contract(
      digioptionsMarketsAbi(),
      digiOptionsMarketsAddr // TODO rename digiOptionsMarketsAddr
    );
    ...
    return {
      ...
      digiOptionsMarketsAddr: digiOptionsMarketsAddr, // TODO rename digiOptionsMarketsAddr
      offer_max_blocks_into_future: offer_max_blocks_into_future,
      payoutPerNanoOptionExp: payoutPerNanoOptionExp,
      payoutPerNanoOption: web3Utils.toBN('10').pow(payoutPerNanoOptionExp),
      nanoOptionsPerOption: web3Utils.toBN('10').pow(web3Utils.toBN('18').sub(payoutPerNanoOptionExp)),
  ...
  function filterEventsByExpirationDatetime(events, expirationDatetimeStart, expirationDatetimeEnd){
    // both ends (expirationDatetimeStart and expirationDatetimeEnd) included // TODO is this ok?
    expirationDatetimeStart = expirationDatetimeStart || 0;
    expirationDatetimeEnd = expirationDatetimeEnd || 0x10000000000; // contract uses 40 bits for expirationDatetime // TODO move to constants
...
//    15 * 60// TODO SHORT_TERM: 6
  ...
  function marketSearchSetup(
    ...
    return {
      ...
      expirationDatetimeEnd: expirationDatetimeEnd || 0xffffffffff,
...
// TODO +1?
  ...
  function getMarketCreateEvents_( //TODO
    contractDescription,
    marketSearch,
...
//    var limitPerFetch = 2; // TODO
  ...
  var payoutPerNanoOptionExp = web3Utils.toBN('9'); // TODO
  ...
  return {
    ...
    signOrder: signOrder,
    // TODO remove
    payoutPerNanoOption: web3Utils.toBN('10').pow(payoutPerNanoOptionExp), // == 1000000000 (in wei)
    // TODO remove
    nanoOptionsPerOption: web3Utils.toBN('10').pow(payoutPerNanoOptionExp), // == 1000000000
